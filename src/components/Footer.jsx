export default function Footer() {
  return (
    <footer className="w-full max-w-4xl mx-auto py-space-lg flex flex-col gap-space-md text-secondary text-body-sm">
      ...
      {/* Bottom row — made-with + GitHub + brand strip */}
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://github.com/D-Sync-Vivek/no-mdr"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 font-medium text-secondary hover:text-primary transition-colors"
